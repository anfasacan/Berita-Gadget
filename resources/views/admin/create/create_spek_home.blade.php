...
@section('judul_tambah_data','Menambah Data Spesifikasi home')
@section('title','add data')

@section('method')
    <form method="POST" class="contact100-form validate-form" action="/admin/A_spek_home" enctype="multipart/form-data">
    @csrf
@endsection
...
<div class="wrap-input100 validate-input" data-validate="Produk is required">
    <span class="label-input100">Produk</span>
     <input class="input100" type="int" name="produk" placeholder="merk/jenis produk" autocomplete="off" required>
    <span class="focus-input100"></span>
</div> 
@endsection
...
@section('data3')
    ...
    <span class="label-input100">Gambar</span>
     <input class="input100" type="text" name="gambar" placeholder="Nama file gambar + extensi" autocomplete="off" required>
    <span class="focus-input100"></span>
</div>  --}}
...
@section('data5')
	...
	<textarea class="input100" name="link" autocomplete="off" placeholder="Masukan Tautan yang bersangkutan ..."></textarea>
	<span class="focus-input100"></span>
     </div>
@endsection
