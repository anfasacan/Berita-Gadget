...
@section('judul_tambah_data','Menambah Data Trobosan Laptop')
@section('title','add data')

@section('method')
    <form method="POST" class="contact100-form validate-form" action="/admin/A_T_laptop" enctype="multipart/form-data">
    @csrf
@endsection
...
@section('back')
<div><a href="{{url('/admin/A_T_laptop')}}"><i class="fa fa-backward"></i> Kembali</a></div>    
@endsection